...
$PollEntityCopyWith<PollEntity> get copyWith => _$PollEntityCopyWithImpl<PollEntity>(this as PollEntity, _$identity);
  ...
  /// Serializes this PollEntity to a JSON map.
...
@override
String toString() {
  return 'PollEntity(id: $id, title: $title, description: $description, creatorId: $creatorId, creatorName: $creatorName, createdAt: $createdAt, expiresAt: $expiresAt, pollType: $pollType, isAnonymous: $isAnonymous, allowMultipleVotes: $allowMultipleVotes, status: $status, questions: $questions, totalVotes: $totalVotes, tags: $tags)';
}
...
class _PollEntity implements PollEntity {
  const _PollEntity({required this.id, required this.title, this.description, required this.creatorId, required this.creatorName, required this.createdAt, this.expiresAt, required this.pollType, this.isAnonymous = false, this.allowMultipleVotes = false, required this.status, required final  List<PollQuestion> questions, this.totalVotes = 0, final  List<String> tags = const []}): _questions = questions,_tags = tags;
  factory _PollEntity.fromJson(Map<String, dynamic> json) => _$PollEntityFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$PollEntityToJson(this, );
}
